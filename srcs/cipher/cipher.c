...
/*   Updated: 2019/12/21 07:09:55 by rpapagna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**
**	JUST TO VERIFY WORKING CONDITION
**
**	FOR EDUCATION
*/
...
void	write_block(int fd, void *block, int bytes)
{
...
void				des_encrypt(t_parse des, t_ssl *ssl)
{
	...
	while (read_pad(des.fd_in, &n, 8))
	{
		...
		// ft_printf("[%llu]\n", encrypted);
		write_block(des.fd_out, &encrypted, 8);
	}
}
